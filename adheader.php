...
<body class="theme-cyan">
    ...
    <nav class="navbar clearHeader">
        <div class="col-12">
            <div class="navbar-header"> <a href="javascript:void(0);" class="bars"></a> <a class="navbar-brand"
                    href="#"><img width="60px" src="assets/images/logo/logo 3.png" alt="Care logo"></a> </div>
            <ul class="nav navbar-nav navbar-right">
                <!-- Notifications -->
                <li>
                    <a style="text-decoration:none;" data-placement="bottom" title="Full Screen" href="logout.php"><i style="margin-right:10px;" class="zmdi zmdi-sign-in"></i>Logout</a>
                </li>               
    ...
    <section>
     ...
     <section style="overflow-x: hidden;" class="content home">
